    ...
    return (
        ...
        >
            <div className="flex items-center justify-center gap-6 text-xl hidden md:flex">
                <a href="https://www.linkedin.com/in/thiraiyan-mooneesawmy-99b8742b0" className="text-neutral-300 hover:text-cyan-400 transition-all duration-300 transform hover:scale-110">
                    <FaLinkedin />
                </a>
                <a href="https://github.com/Niseiyen" className="text-neutral-300 hover:text-purple-400 transition-all duration-300 transform hover:scale-110">
                    <FaGithub />
                </a>
                <motion.a 
            ...
            <AnimatePresence>
                {dropdownOpen && (
                    <motion.div 
                        ...
                        transition={{ duration: 0.5 }}
                    >
                        <a href="https://www.linkedin.com/in/thiraiyan-mooneesawmy-99b8742b0" className="py-2 hover:text-blue-500 transition-colors duration-300">LinkedIn</a>
                        <a href="https://github.com/Niseiyen" className="py-2 hover:text-gray-500 transition-colors duration-300">GitHub</a>
                        <motion.a 
